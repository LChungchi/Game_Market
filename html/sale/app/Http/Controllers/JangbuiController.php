...
class JangbuiController extends Controller
{
    ...
    public function index()
    {
		...
		return view( 'jangbui.index', $data );	// 자료 표시
    ...
    public function show($id)
    {
     ...
     //자료 읽기, Eloquent ORM
		return view('jangbui.show', $data );  //자료 표시
