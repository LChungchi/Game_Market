		...
		<div class="row">
			...
			<table class="table table-bordered table-sm mymargin5">
				...
				<tr>
					...
					<td align="left">
						<div class="d-inline-flex">
							<input type="hidden" name="products_id" value="{{ $row->products_id29 }}">
							<input type="text" name="product_name" value="{{$row->product_name29}}" class="form-control-sm" readonly >&nbsp;
				...
				<tr>
					...
					<td align="left">
						<div class="d-inline-flex">
							<input  type="text" name="numo" size="20" maxlength="20" value="{{ $row->numo29 }}" 
							class="form-control form-control-sm" onChange="cal_prices();">
						</div>
					</td>
				</tr>
