...
<script>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#table_list").append(
                    "<tr id='rowno"+id+"'>"+
                    "    <td>"+id+"</td>"+
                    "    <td><a href='#ajaxModal' data-toggle='modal' data-target='#ajaxModal' class='ajax_edit' data-id='"+id+"' data-name='"+name+"'>"+name+"</a></td>"+
	...
	<form name="form1" action="" >
		<div class="row">
			...
			<div class="col-9" align="right">           
				<a href="#" class="ajax_add btn btn-sm mycolor1" data-bs-target="#ajaxModal" data-bs-toggle="modal" >추가</a>
			</div>
    ...
    <tr id="rowno{{$row->id}}">
		<td>{{ $row->id }}</td>
		<td> <a href="#" data-bs-toggle="modal" data-bs-target="#ajaxModal" class="ajax_edit"
				data-id="{{ $row->id }}" data-name="{{$row->name29}}" >{{ $row->name29 }}</a></td>
