...
\
	...
	<br>
	<div class="alert mycolor1" role="alert">게임사진</div>
		...
		<div class="row">
			...
			<div class="col-6" align="left">            
				<div class="input-group  input-group-sm">
					<span class="input-group-text">게임 이름</span>
					<input type="text" name="text1" value="{{ $text1 }}" class="form-control" placeholder="찾을 게임 이름"
	...
	<?
		...
		$iname2=$row->pic2 ? $row->pic2 : "";
		$pname=$row->gname;	
	?>
	<div class="col-3">
		<div class="mythumb_box" style="background-color:#ffffff">
			<a href="javascript:zoomimage('{{$iname}}', '{{$pname}}');">
			<img src="{{ asset('/storage/game_img/' .$iname) }}" class="mythumb_image" style="cursor:pointer"
			data-bs-toggle="modal" data-bs-target="#zoomModal"
			onclick="document.getElementById('zoomModalLabel').innerText='{{$pname}}';
			picname.src='{{ asset('/storage/game_img/' .$iname2) }}'">
			</a>
